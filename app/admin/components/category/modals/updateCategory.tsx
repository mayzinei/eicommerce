...
const UpdateModal = ({ titleRef, error, setError, showUpdateModal, setUpdateModal, updateCategory, category }) => {
  ...
  return (
    <div className="absolute z-10 inset-0 overflow-y-auto flex items-center justify-center">
      ...
      <div className="bg-white rounded-lg p-8 w-full max-w-lg mx-5 shadow-xl">
        ...
        <form onSubmit={(event) => updateCategory(event)}>
          <div className="mb-4">
          ...
          <div className="flex justify-end">
            <button
              ...
              onClick={() => setUpdateModal(!showUpdateModal)}
            >
              Cancel
            </button>
            <button
